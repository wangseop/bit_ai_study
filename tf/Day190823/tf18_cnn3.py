...
print("L4: ", L4)   # shape=(?, 7, 7, 64)               

# Dense
W5 = tf.Variable(tf.random_normal([2 * 2 * 256, 2 * 2 * 256 * 2]))
b5 = tf.Variable(tf.random_normal([2*2*256*2]))
L5= tf.nn.relu(tf.matmul(L4_flat, W5) + b5)

W6 = tf.get_variable("W6", shape=[2 * 2 * 256 * 2, 10], initializer=tf.contrib.layers.xavier_initializer())
b = tf.Variable(tf.random_normal([10]))
logits = tf.matmul(L5, W6) + b
...
'''
Epoch: 0001 cost= 0.234642575
Epoch: 0002 cost= 0.043992350
Epoch: 0003 cost= 0.032138568
Epoch: 0004 cost= 0.025289495
Epoch: 0005 cost= 0.021305530
Epoch: 0006 cost= 0.020093897
Epoch: 0007 cost= 0.017564774
Epoch: 0008 cost= 0.015210790
Epoch: 0009 cost= 0.012597563
Epoch: 0010 cost= 0.012914704
Epoch: 0011 cost= 0.009840665
Epoch: 0012 cost= 0.011492077
Epoch: 0013 cost= 0.010495670
Epoch: 0014 cost= 0.006290741
Epoch: 0015 cost= 0.009947972
Learning finished!
Accuracy: 0.9904
Label:  [9]
Prediction:  [9]
