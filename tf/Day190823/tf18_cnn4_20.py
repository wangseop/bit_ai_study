...
# from tensorflow.keras import layers         # tensorflow 버전 1.20 부터 가능하지만, 1.14 버전에서도 적용이 된 상태
...
# L3 = tf.keras.layers.conv2d(L2, 64, [3,3], activation=tf.nn.relu)
